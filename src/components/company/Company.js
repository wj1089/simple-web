...
const Company = () => {
  let start = 0; // touch event 시작점 계산
  const [logoArea, setLogoArea] = useState(0); // current view slide
  const [slideWidth, setSlideWidth] = useState(0); // slide width
  const viewSlideCnt = 2; // total slide count
  ...
  const touchFinish = (e) => {
    // 터치를 한번(like tab) 하거나, 조금 움직였는데 변경하는것을 막기위해, value 를 높인다.
    const value = (start.clientX - e.changedTouches[0].clientX) / 10;
  ...
  useEffect(() => {
    if (sliderRef.current != null) {
      const contentCur = window.getComputedStyle(
        sliderRef.current.childNodes[0]
      );
        ...
        <div className="full-screen">
          ...
          <div className="screen-centerArea">
            <div className="center-imgArea-mission">
              <div className="center-imgText">COMPANY</div>
            </div>
            <div>
              <div className="center-selectBar">
                <div className="select-Button">ABOUT</div>
                <a className="disable-Button" href="/Mission">
                  MISSION
                </a>
                <a className="disable-Button" href="/Patent">
                  PATENT
                </a>
              </div>
            </div>
            ...
            <div className="center-aboutArea">
              <div>
                ...
                <p className="center-aboutText">
                  모리아타운은 글로벌 솔루션 리더로
                  <br /> 자리매김 하기 위한 노력을 비전으로 새로운 가치 창조와
                  시장을 선도하는
                  <br /> 기업을 만들기 위해 노력하고 있습니다.
                </p>
                <p className="center-smallText">
                  EMBEDDED 소프트웨어 및 솔루션 전문 기업인 주식회사
                  모리아타운은 2006년 설립 이후, IT분야의 다양한 경험과 경력을
                  바탕으로
                  <br />
                  모바일 및 각종 단말 기기 솔루션 공급업체로 꾸준한 성장과
                  새롭게 펼쳐지는 Global 경쟁시대에 앞서 나가는 기업이 될 수
                  있도록 힘차게 도약하고 있으며,
                  <br />
                  다양한 솔루션 발굴 및 공급 경험을 토대로 보다 창조적이고
                  발전된 기술을 제공하는 것을 주요 업무 영역으로 하고 있습니다.
                </p>
              </div>
            </div>
              ...
              <div className="timeline">
                ...
                <div className="container left">
                  <div className="contentLeft" data-aos="fade-up">
                    ...
                    <div className="hitoryInnerLeftDiv">
                      <p className="historyNoboldTitle">
                        삼성전자 PC S/W 솔루션 공급계약
                      </p>
                    </div>
                  </div>
                </div>
                <div className="container right">
                  <div className="contentRight" data-aos="fade-up">
                    ...
                    <div className="hitoryInnerRightDiv">
                      <p className="historyNoboldTitle">삼성전자 MSC S/W 공급 계약</p>
                      <p className="historyNoboldTitle">
                        IP기반 - 폐쇄형 SNS Party 출시
                      </p>
                      <p className="historyNoboldTitle">
                        IP기반 - 모교기반 SNS Mschool 출시
                      </p>
                    </div>
                  </div>
                </div>
                <div className="container left">
                  <div className="contentLeft" data-aos="fade-up">
                    <div style={{ display: 'inline-flex' }}>
                      <p className="historyNoboldTopTitle">
                        IP 기반 - talktalk Live 상표 등록
                      </p>
                      <p className="yearText">2012</p>
                    </div>
                    <div className="hitoryInnerLeftDiv">
                      <p className="historyNoboldTitle">
                        IP 기반 - talktalk Live 어플리케이션 출시
                      </p>
                      <p className="historyNoboldTitle">
                        IP 기반 - SeeMe 어플리케이션 출시
                      </p>
                    </div>
                  </div>
                </div>
                <div className="container right">
                  <div className="contentRight" data-aos="fade-up">
                    <div style={{ display: 'inline-flex' }}>
                      ...
                      <p className="historyNoboldTopTitle">
                        IP 기반 - 스마트 나비 어플리케이션 출시
                      </p>
                    </div>
                    <div className="hitoryInnerRightDiv">
                      <p className="historyNoboldTitle">제조사 대상 IP 솔루션 강화</p>
                ...
                <div className="container left">
                  <div className="contentLeft" data-aos="fade-up">
                    ...
                    <div className="hitoryInnerLeftDiv">
                      <p className="historyNoboldTitle">SK Telesys S/W 공급 계약</p>
                      <p className="historyNoboldTitle">KT Tech S/W 공급 계약</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="container right">
                  <div className="contentRight" data-aos="fade-up">
                    <div style={{ display: 'inline-flex' }}>
                      ...
                      <p className="historyNoboldTopTitle">문자 입력 특허 사업 착수</p>
                    </div>
                  </div>
                </div>
                <div className="container left">
                  <div className="contentLeft" data-aos="fade-up">
                    <div style={{ display: 'inline-flex' }}>
                      <p className="historyNoboldTopTitle">
                        Pantech & Curitel S/W 공급 계약
                      </p>
                      <p className="yearText">2008</p>
                    </div>
                    <div className="hitoryInnerLeftDiv">
                      <p className="historyNoboldTitle">
                        삼성전자 Display 사업부 S/W 공급 계약
                      </p>
                      <p className="historyNoboldTitle">
                        삼성전자 테크원(카메라사업부) S/W 공급 계약
                      </p>
                    </div>
                  </div>
                </div>
                <div className="container right">
                  <div className="contentRight" data-aos="fade-up">
                    <div style={{ display: 'inline-flex' }}>
                      ...
                      <p className="historyTopTitle">
                        삼성전자 휴대폰 S/W 솔루션 공급 계약
                      </p>
                    </div>
                    <div className="hitoryInnerRightDiv">
                      <p className="historyTitle">
                        LG전자 휴대폰 S/W 솔루션 공급 계약
                      </p>
                    </div>
                  </div>
                </div>
              </div>
              <div className="containerLast leftLast">
                <div className="contentLeft" data-aos="fade-up">
                  <div style={{ display: 'inline-flex' }}>
                    <p className="historyTopLastTitle">
                      주식회사 모리아타운 설립
                    </p>
                    <p className="startText">2006</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="center-commentArea">
              <div className="center-comment">
                ...
                <p className="center-commentText">
                  끊임없는 연구개발과 기술공급에 최선의 노력을 다하고 있으며,
                  <br />
                  BLUE OCEAN 창출에 노력하고 있습니다.
                </p>
                <p className="center-smallText">
                  모리아타운은 IT업계의 태동기 때부터 쌓아온 저력을 바탕으로
                  2006년 9월 설립된 회사입니다.
                  <br />
                  <br /> 회사의 창립이래 지금까지 주요 업계에 다양한 솔루션과
                  기술을 공급하는 것을 사명으로 업무를 진행하는 저희
                  모리아타운은
                  <br /> 주요 IT분야의 제조사 대상으로 여러 가지 비즈니스를
                  알차게 진행하고 있습니다. 또한, 여러모로 많은 성원을 보내
                  주시는 고객사의 신뢰에 보답하기 위해
                  <br /> 끊임없는 연구개발과 기술공급에 최선의 노력을 다하고
                  있으며, 기존 틀에서 벗어난 보다 창의적인 기술로 차별화된
                  새로운 대안을 제시하고,
                  <br /> 이를 통한 BLUE OCEAN 창출에 노력하고 있습니다.
                  <br />
                  <br />
                  <p>
                    특히 S/W 산업 부문에 있어서 다양한 실적과 결과를 지속해서
                    보여드릴 것을 약속드리며
                    <br /> 아울러 다양한 가치 창출의 비즈니스 분야에 있어 선도적
                    역할을 담당한다는 사명을 지켜나갈 것입니다.
                    <br /> 저희 홈페이지를 찾아 주신 여러분께 다시 한 번 감사를
                    드리며, 지속적인 격려와 성원을 부탁드립니다.
                  </p>
                </p>
            ...
            <div className="center-partnerArea">
              <div className="center-partner">
                ...
                <div className="partners-slideArea">
                  <img
                    className="partners-iconImg"
                    src={arcSoft}
                    alt="parter-arcSoft"
                  />
                  <img
                    className="partners-iconImgCenter"
                    src={samsung}
                    alt="parter-samsung"
                  />
                  <img
          ...
          <main className="m-screen-fullArea">
            <div className="m-company-mobile">
              ...
              <div className="m-center-selectBar">
                ...
                <a className="m-disable-Button" href="/mission">
                  MISSION
                </a>
                <a className="m-disable-Button" href="/patent">
                  PATENT
                </a>
              </div>
            </div>
            ...
            <div className="m-center-contentArea-company">
              <div className="m-center-aboutArea">
                <div className="m-company-center">
                  ...
                  <p className="m-center-smallText">
                    ...
                    주식회사 모리아타운은 2006년 설립 이후, IT분야의
                    다양한 경험과 경력을 바탕으로
                    <br /> 모바일 및 각종 단말 기기 솔루션 공급업체로 꾸준한
                    성장과 새롭게 펼쳐지는 Global 경쟁시대에 앞서 나가는
                    기업이 될 수 있도록 힘차게 도약하고 있으며,
                    <br />
                    다양한 솔루션 발굴 및 공급 경험을 토대로 보다 창조적 이고
                    발전된 기술을 제공하는 것을 주요 업무 영역으로
                    <br /> 하고 있습니다.
                  </p>
                </div>
              </div>
              ...
              <div className="m-center-commentArea">
                ...
                <p className="m-center-smallText-cmt">
                  ...
                  <br /> 회사의 창립이래 지금까지 주요 업계에 다양한 솔루션과
                  기술을 공급하는 것을 사명으로 업무를 진행하는 저희
                  모리아타운은 주요 IT분야의 제조사 대상으로 여러 가지
                  비즈니스를 알차게 진행하고 있습니다. 또한, 여러모로 많은
                  성원을 보내 주시는 고객사의 신뢰에 보답하기 위해 끊임없는
                  연구개발과 기술공급에 최선의 노력을 다하고 있으며, 기존 틀에서
                  벗어난 보다 창의적인 기술로 차별화된 새로운 대안을 제시하고,
                  이를 통한 BLUE OCEAN 창출에 노력하고 있습니다.
                  <br />
                  <br />
                  <p>
                    특히 S/W 산업 부문에 있어서 다양한 실적과 결과를 지속해서
                    보여드릴 것을 약속드리며 아울러 다양한 가치 창출의 비즈니스
                    분야에 있어 선도적 역할을 담당한다는 사명을 지켜나갈
                    것입니다.
                    <br />
                    <br /> 저희 홈페이지를 찾아 주신 여러분께 다시 한 번
                    감사를 드리며, 지속적인 격려와 성원을 부탁드립니다.
                  </p>
                </p>
                <div className="m-center-commetSign">
                  <img
                    className="m-sign-area"
                    src={sign}
                    alt="moriagtown-sign"
                  />
                </div>
              ...
              <div className="m-center-partnerArea">
                ...
                <div className="m-slidePage">
                  <button
                    type="button"
                    className={
                      logoArea === 0 ? 'm-able-circle' : 'm-disable-circle'
                    }
                  >
                    {/* empty  */}
                  </button>
                  ...
                  <button
                    type="button"
                    className={
                      logoArea === 1 ? 'm-able-circle' : 'm-disable-circle'
                    }
                  >
                    {/* empty  */}
                  </button>
                  ...
                  <button
                    type="button"
                    className={
                      logoArea === 2 ? 'm-able-circle' : 'm-disable-circle'
                    }
                  >
                    {/* empty  */}
                  </button>
