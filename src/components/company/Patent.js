...
import tradeSistem from '../../resourse/patent/20131122_모듈 단위 업무 매매 시스템 및 방법_page-0001.png'
              ...
              <div className="m-screen-center-Area-company">
                ...
                <div className="m-center-contentArea-company">
                  ...
                  <div className="m-patent-imgArea">
                    ...
                    <tr className="m-patent-imgSize">

                      <td className="m-icon-outLine">
                        <img className="m-icon-size" src={pefamServ} alt="pefam-service-patent" />
                        <div className="m-icon-descrip">페팸서비스등록</div>
                      </td>

                      <td className="m-icon-outLine">
                        <img className="m-icon-size" src={tradeSistem} alt="tradeSistem-patent" />
                        <div className="m-icon-descrip">모듈 단위 업무 매매 시스템 및 방법</div>
                      </td>
